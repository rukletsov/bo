...
protected:
    virtual void SetUp()
    {
        filename = "D:/Work/C++/sln_libCommon/bin/data/ini_reader_test_01.ini";
    }
...
TEST_F(IniReaderTest, DefaultConstructor)
{
    ...
    EXPECT_STREQ("default_value", reader.get_value("some_section", "some_subsection", "", "default_value").c_str());
}
...
TEST_F(IniReaderTest, DefaultBehaviour)
{
    ...
    EXPECT_STREQ("", 
        reader.get_value("Section02", "Subsection01.Subsubsection", "key_in_sub_sub_section", "").c_str());
    EXPECT_STREQ("", 
    ...
    EXPECT_STREQ("", 
        reader.get_value("Section.WithPointInName", "key_in_section_with_a_point_in_name", "").c_str());
    ...
    EXPECT_STREQ("value_in_subsection_before_section", 
        reader.get_value("Section03", "SubSectionBeforeSection", "key_in_subsection_before_section", "").c_str());
